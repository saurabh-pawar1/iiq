            ...
            if ( name && name.length > 0 ) {
                ...
                if ( name === "assignedRoles" || name === "detectedRoles" ) {
                    ...
                    if ( roleId != null ) {
                          ...
                          roleLink = Ext.String.format('<a href="javascript:SailPoint.RoleDetailPanel.window(null, \'{0}\', \'{1}\', true, null, \'{2}\', undefined, undefined, \'identity\', \'{1}\')" title="#{msgs.info_role_composition}">{3}</a>', roleId, identityId, name, rendered);
                    		} else {
                          roleLink = Ext.String.format('<a href="javascript:SailPoint.RoleDetailPanel.window(\'{0}\', \'{1}\', \'{2}\', true, null, \'{3}\', undefined, undefined, \'identity\', \'{2}\')" title="#{msgs.info_role_composition}">{4}</a>', assignmentId, roleId, identityId, name, rendered);
                    		}
