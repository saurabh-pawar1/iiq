		...
		Ext.apply(config, {
			...
			proxy: {
                ...
                extraParams: {
                    ...
                    refererType: config.refererType,
                    refererId: config.refererId
                }
            },
			listeners: {
                beforeload: {
...
SailPoint.RoleDetailPanel.window = function(assignmentId, selectedRoleId, selectedIdentityId, isAssignedRole, windowType, roleType, requestId, id2, refererType, refererId) {
 ...
 *            item.[Optional]
 */
SailPoint.RoleDetailPanel.toggle = function(selectedRoleId, selectedIdentityId, isAssignedRole, targetElement, certificationItemId, link, assignmentId, roleType, refererType, refererId) {
